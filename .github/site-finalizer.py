...
required = [
    ...
    REPORT_URL, 'legacy-index.html', 'zones.json', '<title>UBG43 - 1000+ Unblocked Games</title>', '.ubg43-home-secondary{display:none}.ubg43-searching .ubg43-home-secondary{display:block}'
]
